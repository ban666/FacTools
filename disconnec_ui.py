...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.currentTimes.setGeometry(QtCore.QRect(140, 50, 251, 51))
        ...
        self.remainTime.setGeometry(QtCore.QRect(140, 150, 251, 51))
...
if __name__ == "__main__":
    ...
    ui.remainTime.display('1111:11:11')
    ui.currentTimes.display('9999999')
    MainWindow.show()
    sys.exit(app.exec_())